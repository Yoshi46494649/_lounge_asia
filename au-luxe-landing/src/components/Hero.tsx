...
import { Heart, Shield, Users, Mail, Lock } from "lucide-react";
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-white leading-tight px-4">
            Find Your Match Who <em>Gets</em> Your Culture. Brisbane's Asian Speed Dating.
          </h1>

          {/* Subheadline - Mobile Optimized */}
          <p className="text-base sm:text-lg md:text-xl text-white/95 max-w-2xl mx-auto leading-relaxed px-4">
            Tired of the apps? Meet genuine Asian singles in a safe, curated Brisbane setting. Leave your email to be invited before tickets go public.
          </p>
          ...
          >
            <div className="relative w-full sm:max-w-sm">
              <Mail className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 w-5 h-5 sm:w-6 sm:h-6 text-white/70" aria-hidden="true" />
              <Input
                type="email"
                value={email}
                onChange={(event) => setEmail(event.target.value)}
                placeholder="Enter your email address"
                className="h-12 md:h-14 rounded-xl bg-white/15 pl-11 sm:pl-14 text-white placeholder:text-white/70 border-white/20 focus:border-white/60 focus:ring-white/50"
            ...
            <Button
              ...
              disabled={isSubmitting}
            >
              {isSubmitting ? "Joining..." : "Claim Early Access"}
            </Button>
          </form>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-6 pt-6 sm:pt-8 max-w-3xl mx-auto px-4">
            <div className="bg-white/10 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border border-white/20 transition-all duration-300 hover:bg-white/15">
              <Shield className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-white mx-auto mb-2 sm:mb-3" aria-hidden="true" />
              <h3 className="text-white font-bold mb-1 text-sm sm:text-base md:text-lg">Verified Guests</h3>
              <p className="text-white/80 text-xs sm:text-sm md:text-base">ID check at check-in</p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border border-white/20 transition-all duration-300 hover:bg-white/15">
              <Users className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-white mx-auto mb-2 sm:mb-3" aria-hidden="true" />
              <h3 className="text-white font-bold mb-1 text-sm sm:text-base md:text-lg">Balanced Pairings</h3>
              <p className="text-white/80 text-xs sm:text-sm md:text-base">Equal seats for men & women</p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border border-white/20 transition-all duration-300 hover:bg-white/15">
              <Heart className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-white mx-auto mb-2 sm:mb-3" aria-hidden="true" />
              <h3 className="text-white font-bold mb-1 text-sm sm:text-base md:text-lg">Match Results</h3>
              <p className="text-white/80 text-xs sm:text-sm md:text-base">Delivered next evening</p>
            </div>
          </div>
        </div>
      </div>
